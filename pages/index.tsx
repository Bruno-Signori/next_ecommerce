...
import BoxServicesContainer from '../components/BoxServicesContainer.tsx';
...
export default function Home() {
  ...
  return (
    ...
    >
        <SEO 
      title="TechGear, logitech landing page" shouldExcludeTitleSuffix
      />
    <Box 
    d="flex"
    marginTop="100px"
      ...
      <Box height="100%" width="35%" marginTop="150px">
      <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
